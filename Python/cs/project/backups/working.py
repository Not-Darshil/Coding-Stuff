...
def dbtable():
    ...
    crsr.execute("create table if not exists product(PNO int,PNAME char(25),BRAND char(25),MRP int,SELLINGP int,QTY int,primary key(PNO))")
    ...
    while y==0:
        try:
            ...
            if no==0:
                ...
                crsr.execute("desc product;")
                recs=crsr.fetchall()
                print(recs[0][0].ljust(7),recs[1][0].ljust(25),recs[2][0].ljust(25),recs[3][0].ljust(10),recs[4][0].ljust(10),"PRICE".ljust(10),"DISC".ljust(10),"COST".ljust(10))
##                crsr.execute("desc product;")
##                recs=crsr.fetchall()
##                print("%3s  %-15s %-15s %4s  %-3s  %-5s %5s %5s"%(recs[0][0],recs[1][0],recs[2][0],recs[3][0],"QTY","PRICE","DISC","COST"))
                for i in range(len(pnolist)):
                    ...
                    print(rec[0].ljust(7),rec[1].ljust(25),rec[2].ljust(25),rec[3].ljust(10),qtylist[i].ljust(10),(rec[3]*qtylist[i]).ljust(10),disc.ljust(10),cost.ljust(10))
...
##                        break
                    ...
                    crsr.execute("desc product;")
                    recs=crsr.fetchall()
                    print(recs[0][0].ljust(3),recs[1][0].ljust(25),recs[2][0].ljust(25),recs[3][0].ljust(10),recs[4][0].ljust(10),"AMOUNT".ljust(10),"COST".ljust(10))
                    print(str(rec[0]).ljust(3),rec[1].ljust(25),rec[2].ljust(25),str(rec[3]).ljust(10),str(rec[4]).ljust(10),str(amount).ljust(10),str(cost).ljust(10))
